        ...
        <li>
            <li class="product-filters-tab">
                ...
                <ul class="categories-menu menu vertical nested">
                    <li><label for="price-checkbox1">Under $300<input class="price-checkbox" type="checkbox" value="0-300"></label></li>
                    <li><label for="price-checkbox2">$310–$500<input class="price-checkbox" type="checkbox" value="310-500"></label></li>
                    <li><label for="price-checkbox3">$510–$700<input class="price-checkbox" type="checkbox" value="510-700"></label></li>
                    <li><label for="price-checkbox4">$710–$1,000<input class="price-checkbox" type="checkbox" value="710-1000"></label></li>
                    <li><label for="price-checkbox5">$1,100 +<input class="price-checkbox" type="checkbox" value="1100+"></label></li>
                </ul>
            </li>
        </li>
    </ul>
