...
<body>
	<div class="header">
		<h1>About us</h1>
		<p>The story behind Mes Yeux Tes yeux</p>
	</div>
	...
	<div class="story-container">
		<div class="story-content">
			...
			<div class="story-text">
				...
				<p>Optician, entrepreneur and designer, Marie-Sophie Dion (MSD) is the founder of the Mes Yeux Tes yeux concept, where the customer lets himself be served like a king. Since entering the field in 1992, she quickly made known her talent as a curator for creative and avant-garde frames, all over the world. 300 distinct models are offered in 28 colors and are available exclusively at our 5 boutiques.</p>
			</div>
		</div>
        <br>
