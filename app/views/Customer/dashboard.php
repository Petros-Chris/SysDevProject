...
<body>
    <div class='container'>
            ...
            <button type="button" onclick="window.location.href = '/User/register'" class="signup-button">View Tickets You Made</button>
            <button type="button" onclick="window.location.href = '/Review/byUser'" class="signup-button">View Reviews You Made</button>
            <button type="button" onclick="window.location.href = '/Review/index'" class="signup-button">View Previous Orders</button>
    </div>
</body>
