...
<body data-new-gr-c-s-check-loaded="14.1162.0" data-gr-ext-installed="">
	<div class="container">
		<h1>Post deletion</h1>
		<p>Confirm deletion by providing the password assigned at the time of creation of this post.</p>
		<form method="post" action="">
			<div class="form-group">
				<label>Message:<textarea class="form-control" name="message" placeholder="Hello World!" disabled="disabled">Hello World!</textarea></label>
			</div>
			<div class="form-group">
