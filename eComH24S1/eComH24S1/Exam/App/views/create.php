...
<body data-new-gr-c-s-check-loaded="14.1162.0" data-gr-ext-installed="">
	<div class="container">
		...
		<form method="post" action="">
			...
			<div class="form-group">
				<label>Modification/deletion password:<input type="password" class="form-control" name="password" placeholder="password" fdprocessedid="bf28vj"></label>
			</div>

			<div class="form-group">
				<input type="submit" name="action" value="Create Post" fdprocessedid="mddxv"> 
				<a href="/Post/index">cancel</a>
			</div>
		</form>
	</div>

<span id="PING_IFRAME_FORM_DETECTION" style="display: none;"></span></body><grammarly-desktop-integration data-grammarly-shadow-root="true"></grammarly-desktop-integration></html>